...
app.get('/', (req, res) => {
        ...
        <body>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                <li><strong>GET /users</strong> - Retrieve a list of users</li>
                <li><strong>POST /users</strong> - Create a new user</li>
                <li><strong>GET /users/:id</strong> - Retrieve a specific user</li>
                <li><strong>PUT /users/:id</strong> - Update a specific user</li>
                <li><strong>DELETE /users/:id</strong> - Delete a specific user</li>
              </ul>
            </li>
          </ul>
          ...
          <pre><code>POST /tasks
  {
    ...
    "description": "Task description"
          ...
          <p>For more detailed API documentation, visit: <a href="http://your-documentation-link">API Documentation</a></p>
        </body>
      </html>
    `);
  });
